...
export class ResponseMessage {
    static messages: Map<string, string> = new Map([
        ...
        ["1223", "The shop ID is invalid"],
        ["1224", "The ID of the clearing manager and the ID of the shop should be different"],
        ...
        ["1551", "Expired signature"],
        ["1552", "Only a settlement manager can execute"],
        ["1553", "Settlement Manager does not match the registered value"],
