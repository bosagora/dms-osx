...
import { getPhoneLinkCollectionContractAddress, PHONE_LINK_COLLECTION_ADDRESSES } from "../helpers";
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    const linkCollectionContractAddress = await getPhoneLinkCollectionContractAddress("EmailLinkCollection", hre);
